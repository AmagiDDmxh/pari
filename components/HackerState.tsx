  ...
  return (
    <section className="" ref={containerRef}>
      <div className="-z-20 relative">
        ...
        <div className="h-[80vh] w-[100vw] bg-[#9290F2] ">
          <div
            className={cx(
          ...
          >
            ...
            <img
              ...
              className="absolute left-0 right-0 -bottom-52 z-20 object-cover w-full h-full transform rotate-[2deg]  scale-110"
            />
          </div>

          <div className="w-full flex items-center justify-end">
            <div className="max-w-sm lg:max-w-screen-sm mt-48 mr-32 relative z-0 text-primary-black text-3xl space-y-4">
      ...
      <div className="relative z-40 bg-secondary-black text-white py-24 px-20 flex flex-col">
        <h1 className="text-5xl">Why ZKML ?</h1>

        <div className="flex flex-wrap justify-between mt-8 -mr-20">
          <div className="mb-12 md:w-1/2 lg:w-1/3 pr-20 space-y-6">
            <h5 className="text-xl">Risky</h5>
            <h1 className="text-5xl">The flaws of Traditional Platforms</h1>
          ...
          <div className="mb-12 md:w-1/2 lg:w-1/3 pr-20 space-y-6">
            <h5 className="text-xl">Innovative</h5>
            <h1 className="text-5xl">The Solution of ZKML</h1>
          ...
          <div className="mb-12 md:w-1/2 lg:w-1/3 pr-20 space-y-6">
            <h5 className="text-xl">Promising</h5>
            <h1 className="text-5xl">The Benefits of ZKML</h1>
        ...
        <div className="mt-12">
          <Button className={cx("bg-[#B2ADF4] text-secondary-black uppercase")}>
            How to get involed {"  ->"}
          </Button>
        </div>
      </div>
